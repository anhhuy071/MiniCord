...
| Write `.cursor/prds/{name}.prd.md` | Produce an implementation plan — that's `/plan` |
...
**Output path**: `.cursor/prds/{kebab-case-name}.prd.md`
...
```
PRD created: .cursor/prds/{name}.prd.md
...
Next step: /plan .cursor/prds/{name}.prd.md
